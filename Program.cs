...
Human Dominika = new("Dominika", "Nowak", "female", 23);
...
Console.WriteLine(ElaEmployee.ToString());
ElaEmployee.AddYearsEmployed();
Console.WriteLine("Pracownik po 7 latach: " + ElaEmployee.ToString());
...
ElaSpecialist.AddSkillLevel();
Console.WriteLine("Specjalista na sterydach: " + ElaSpecialist.ToString());
